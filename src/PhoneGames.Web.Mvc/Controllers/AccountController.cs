...
using PhoneGames.Sessions;
using PhoneGames.Web.Models.Account;
using PhoneGames.Web.Views.Shared.Components.TenantChange;

namespace PhoneGames.Web.Controllers
{
    public class AccountController : PhoneGamesControllerBase
    {
